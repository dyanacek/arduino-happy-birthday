...
(slight modifications to "Example sketch 09" from the Arduino 
...
int beats[] = {3,1,4,4,4,4,4, 3,1,4,4,4,4,4, 3,1,4,4,4,4,3,1, 3,1,4,4,4,4};
...
int frequency(char note) 
{
  ...
  int frequencies[] = {262, 294, 330, 349, 392, 440, 465, 523};
